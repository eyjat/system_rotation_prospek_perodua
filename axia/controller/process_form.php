...
function rotateSalesAgent($location) {
    ...
    $sql = "SELECT nameSA, phoneNum FROM axiaSA WHERE locationSA = '$location'";
...
if ($assignedAgentData) {
    ...
    $updateAgentQuery = "UPDATE axiaSA SET assignedAgent = '$assignedAgent', assignedPhone = '$assignedPhone' WHERE locationSA = '$location'";

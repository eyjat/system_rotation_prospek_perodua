<?php
$tableName = "alzaSA"; //set table name here
include 'db.php';
...
function rotateSalesAgent($location) {
    ...
    $sql = "SELECT nameSA, phoneNum FROM alzaSA WHERE locationSA = '$location'";
...
if ($assignedAgentData) {
    ...
    $updateAgentQuery = "UPDATE alzaSA SET assignedAgent = '$assignedAgent', assignedPhone = '$assignedPhone' WHERE locationSA = '$location'";
...
$sqlInsert = "INSERT INTO alzaData (prosName, prosNum, prosLocation, curDate, saName) VALUES ('$prosName', '$prosNum', '$prosLocation', '$currentDate', '$assignedAgent')";
$conn->query($sqlInsert);

// WhatsApp API integration
$whatsappApiUrl = "https://api.whatsapp.com/send?phone=6$assignedPhone&text=Hai%20saya%20$prosName,%20berminat%20nak%20beli%20alza.";

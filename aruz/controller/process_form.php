...
function rotateSalesAgent($location) {
    ...
    $sql = "SELECT nameSA, phoneNum FROM aruzSA WHERE locationSA = '$location'";
...
if ($assignedAgentData) {
    ...
    $updateAgentQuery = "UPDATE aruzSA SET assignedAgent = '$assignedAgent', assignedPhone = '$assignedPhone' WHERE locationSA = '$location'";

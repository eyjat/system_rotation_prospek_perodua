...
<body class="bg-gray-100 p-4 md:p-0 flex items-center justify-center h-screen">
    ...
    <img src="https://www.perodua.com.my/assets/images/header_menu/perodua-logo.jpg" alt="Perodua Logo"
        ...
        <form action="process_form.php" method="post">
            ...
            <select name="locationSA" id="location" class="w-full p-2 border rounded">
            ...
            <button type="submit"
                class="block w-full bg-green-500 text-white font-bold py-2 px-4 mt-4 rounded hover:bg-green-600 focus:outline-none focus:ring focus:ring-green-300"><i class="fa-brands fa-whatsapp"></i> Whatsapp Now</button>

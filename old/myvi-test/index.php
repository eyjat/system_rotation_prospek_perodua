                                ...
                                <tr class="hover:bg-gray-200">
                                  ...
                                  <?php   
                                    ...
                                    if(isset($_GET['search_query'])) {
                                        ...
                                        // SQL query to fetch data from the database with search condition
                                    ...
                                    if ($resultSaList->num_rows > 0) {
                                        //echo "<table>"; // Add the table tag

                                        // Loop through the results of the database query
                                        while ($row = $resultSaList->fetch_assoc()) {
                                            // Display data columns for database query results
                                        ...
                                        // Display any additional data here...

...
?>
<a href="myvi.php" class="float-right">
    <button class="remove-filter bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring focus:ring-red-300">
...
?>
        <a href="add_sa_myvi.php" ><button class="add-sa-button bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded float-right focus:outline-none focus:ring focus:ring-blue-300">
            <svg class="w-5 h-5 inline-block mr-2 align-middle mt-0.5" fill="currentColor" viewBox="0 0 28 28"
            xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd"
                                  ...
                                  <?php
                                    ...
                                    if (isset($_GET['filter_option'])) {
                                        ...
                                        if ($filterOption === 'active') {
                                            ...
                                            $sql = "SELECT * FROM myviSA WHERE endDate >= CURDATE()";
                                    ...
                                    if (isset($_GET['search_query'])) {
                                        ...
                                        if (isset($sql)) {
                                            $sql = "SELECT * FROM myviSA WHERE nameSA LIKE '%$searchQuery%'";
                                        } else {
                                            $sql = "SELECT * FROM myviSA";
                                        }
                                    }
                                    ...
                                    if ($resultSaList->num_rows > 0) {
                                        while ($row = $resultSaList->fetch_assoc()) {
                                            ...
                                            echo '</svg>';
                                            echo '</a>';
                                            echo '<a href="delete_myvi.php?id=' . $row['id'] . '" class="text-red-600 hover:text-red-800 mr-2" onclick="return confirmDelete();">';
                        ...
                        <nav class="flex justify-end mt-4">
                            <ul class="flex items-center">
                                <li class="mr-2">
                                    ...
                                    // Previous page link
                                    if ($currentpage > 1) {
                                        echo "<a href='your_page_url.php?page=" . ($currentpage - 1) . "' class='block border border-gray-300 rounded-md px-3 py-1 text-sm text-gray-700 hover:bg-gray-200'>Previous</a>";
                                    }
                                    ?>
                                </li>
                                <?php
                                ...
                                for ($i = 1; $i <= $totalPages; $i++) {
                                    echo "<li class='mr-2'>";
                                    echo "<a href='your_page_url.php?page=$i' class='block border rounded-md px-3 py-1 text-sm";
                                    if ($i === $currentpage) {
                                        echo " border-blue-500 bg-blue-500 text-white hover:bg-blue-500";
                                    } else {
                                        echo " border-gray-300 text-gray-700 hover:bg-gray-200";
                                    }
                                    echo "'>$i</a>";
                                    echo "</li>";
                                }
                                ...
                                <li class="mr-2">
                                    ...
                                    if ($currentpage < $totalPages) {
                                        echo "<a href='myvi.php?page=" . ($currentpage + 1) . "' class='block border border-gray-300 rounded-md px-3 py-1 text-sm text-gray-700 hover:bg-gray-200'>Next</a>";
                                    }
                                    ?>
                                </li>
                            </ul>
                ...
                <div class="mb-8 mt-20">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <div class="flex items-stretch">
                                    <form id="myForm" method="POST" action="filter_leads.php">
                                        <label for="start_date" class="text-gray-600">Select Date:</label>
                                        <input type="date" id="start_date" name="start_date" class="border rounded-md py-1 px-2 focus:ring focus:ring-blue-300">
                                        
                                        <label for="end_date" class="text-gray-600">Select Date:</label>
                                        <input type="date" id="end_date" name="end_date" class="border rounded-md py-1 px-2 focus:ring focus:ring-blue-300">
                                    
                                        <button name="filter" type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring focus:ring-blue-300">
                                            Apply
                                        </button>
                                    </form>
                            </div>
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    filterButton.addEventListener("click", function() {
                                        ...
                                        // Send the selected dates to the server using AJAX
                                        ...
                                        xhr.open("POST", "filter_leads.php", true);
                    ...
                    <div class="bg-white p-6 shadow-md rounded-2xl overflow-hidden">
                        <table class="table-fixed w-full">
                            ...
                            ?>
                            <!-- script for button apply for selected date-->
                            <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    const filterButton = document.getElementById("filterButton");

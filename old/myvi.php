...
//retrieve data query by date
//$sqlLeadDate = "SELECT * FROM myviData";
//$startDate = $conn->query($sqlLeadDate);
                            ...
                            <tbody>
                                <tr class="hover:bg-gray-200">
                                  ...
                                  <?php
                                    ...
                                    $visiblePages = 2; // Number of visible pagination links
                                    ...
                                    if ($resultSaList->num_rows > 0) {
                                        ...
                                        echo "<tr><td colspan='8' class='py-4 px-4 border-b border-gray-100'>No users found.</td></tr>";
                                    }
                                    $connection->close();
                                ?>
                                </tr>
                        ...
                        <div class="flex space-x-4">
                            ...
                            <div class="flex items-stretch">
                                    <form id="myForm" method="GET" action="">
                                        <label for="selectedDate" class="text-gray-600">Select Date:</label>
                                        <input type="date" id="selectedDate" name="selectedDate" class="border rounded-md py-1 px-2 focus:ring focus:ring-blue-300">

                                        <button name="" type="submit" id = "applyFilter" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring focus:ring-blue-300">
                                            Apply
                                        </button>
                                    </form>
                            </div>
                    ...
                    <div class="bg-white p-6 shadow-md rounded-2xl overflow-hidden">
                        <table class="table-fixed w-full">
                            ...
                            <tbody id = "tablebody">
                                ...
                                <?php
                                    // Assuming $resultLead contains your fetched data
                                    if (isset($_GET['selectedDate'])) {
                                        $selectedDate = $_GET['selectedDate'];

                                        // Modify your SQL query to filter data by date
                                        $sqlLeadDate = "SELECT * FROM myviData WHERE curDate = '$selectedDate'";
                                        $resultLeadDate = $conn->query($sqlLeadDate);

                                        if ($resultLeadDate->num_rows > 0) {
                                            while ($row = $resultLeadDate->fetch_assoc()) {
                                                // Display filtered rows here
                                                echo "<tr class='hover:bg-gray-200'>";
                                            ...
                                            echo "<tr><td colspan='5' class='border px-4 py-2'>No users found.</td></tr>";
                                        }
                                    } else {
                                        // Display all data if no filter is applied
                                        // Your existing code for displaying all lead rows here
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    const tableRows = document.querySelectorAll(".hover:bg-gray-200");
